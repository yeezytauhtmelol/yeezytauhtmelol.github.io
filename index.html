...
<body>
  ...
  <section id="contact">
    ...
    <!--
      ...
      2. Create a new form and set the email to yeezustauhtme@gmail.com
      3. Replace "YOUR_FORM_ID" below with the form ID Formspree gives you (looks like: xpwzabcd)
    -->
    ...
    document.getElementById("contact-form").addEventListener("submit", async function(e) {
      ...
      try {
        ...
        if (res.ok) {
          ...
          responseEl.innerText = "✅ Thank you! Your message has been sent.";
          form.reset();
        } else {
          const json = await res.json();
          responseEl.style.color = "red";
          responseEl.innerText = "❌ Error: " + (json.error || "Something went wrong. Please try again.");
        }
      } catch (err) {
        responseEl.style.color = "red";
